...
describe("clearWorkspaceStorage", () => {
  it("removes all workspace-scoped keys for given wsId", () => {
    ...
    expect(adapter.removeItem).toHaveBeenCalledWith("rimedeck_issue_draft:ws_123");
    expect(adapter.removeItem).toHaveBeenCalledWith("rimedeck_issues_view:ws_123");
    expect(adapter.removeItem).toHaveBeenCalledWith("rimedeck_issues_scope:ws_123");
    expect(adapter.removeItem).toHaveBeenCalledWith("rimedeck_my_issues_view:ws_123");
    ...
    expect(adapter.removeItem).toHaveBeenCalledWith("rimedeck_navigation:ws_123");
