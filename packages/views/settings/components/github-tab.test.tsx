...
vi.mock("@rimedeck/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@rimedeck/core/github")>("@rimedeck/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/RimeDeck will stop receiving webhooks/i)).toBeTruthy();
