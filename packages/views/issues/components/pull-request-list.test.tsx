...
import type { GitHubPullRequest } from "@rimedeck/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@rimedeck/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@rimedeck/core/github/queries")>(
    "@rimedeck/core/github/queries",
  );
  return {
    ...actual,
