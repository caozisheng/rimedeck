...
// Mock @rimedeck/core/paths — after the URL-driven workspace refactor,
...
// Mock @rimedeck/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
// Mock issue config
vi.mock("@rimedeck/core/issues/config", () => ({
...
vi.mock("@rimedeck/core/issues/stores/view-store", () => ({
...
vi.mock("@rimedeck/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@rimedeck/core/issues/stores/selection-store", () => ({
...
vi.mock("@rimedeck/core/issues/stores/recent-issues-store", () => ({
