...
vi.mock("@rimedeck/core/issues/stores/draft-store", () => ({
...
vi.mock("@rimedeck/core/issues/stores/quick-create-store", () => ({
...
vi.mock("@rimedeck/core/api", async () => {
  ...
  const { parseWithFallback } = await vi.importActual<typeof import("@rimedeck/core/api/schema")>(
    "@rimedeck/core/api/schema",
  );
  const { DuplicateIssueErrorBodySchema } = await vi.importActual<
    typeof import("@rimedeck/core/api/schemas")
  >("@rimedeck/core/api/schemas");
  return {
    api: {},
    ApiError,
    parseWithFallback,
...
vi.mock("@rimedeck/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@rimedeck/ui/components/common/file-upload-button", () => ({
