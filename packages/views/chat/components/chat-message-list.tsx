...
import { useAutoScroll } from "@rimedeck/ui/hooks/use-auto-scroll";
import { isTaskMessageTaskId, taskMessagesOptions } from "@rimedeck/core/chat/queries";
import { Markdown } from "@rimedeck/views/common/markdown";
import { copyText } from "@rimedeck/ui/lib/clipboard";
import { AttachmentList } from "../../issues/components/comment-card";
import type { AgentAvailability } from "@rimedeck/core/agents";
import type { ChatMessage, ChatPendingTask, TaskFailureReason } from "@rimedeck/core/types";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@rimedeck/core/types").Attachment[];
}) {
