...
import { Button, buttonVariants } from "@rimedeck/ui/components/ui/button";
import { RimeDeckIcon } from "@rimedeck/ui/components/common/rimedeck-icon";
import { captureDownloadIntent } from "@rimedeck/core/analytics";
...
import type { IssueStatus } from "@rimedeck/core/types";
        ...
        <div className="flex flex-1 flex-col justify-center px-6 pb-12 sm:px-10 md:px-20 lg:px-20 xl:px-24">
          <div className="flex w-full max-w-[540px] flex-col gap-8">
            <div className="flex items-center gap-2.5">
              <RimeDeckIcon className="size-5 text-foreground" noSpin />
