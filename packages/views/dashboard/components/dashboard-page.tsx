...
const EMPTY_DAILY: import("@rimedeck/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@rimedeck/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@rimedeck/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@rimedeck/core/types").DashboardRunTimeDaily[] = [];
