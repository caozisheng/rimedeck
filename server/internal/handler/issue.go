...
func (h *Handler) QuickCreateIssue(w http.ResponseWriter, r *http.Request) {
	...
	task, err := h.TaskService.EnqueueQuickCreateTask(r.Context(), wsUUID, requesterUUID, agentUUID, squadUUID, prompt, issue.ID, projectUUID, parentIssueUUID, attachmentIDs)
	if err != nil {
...
func (h *Handler) CreateIssue(w http.ResponseWriter, r *http.Request) {
	...
	if req.DueDate != nil && *req.DueDate != "" {
		...
		if err != nil {
			writeError(w, http.StatusBadRequest, "invalid due_date: "+err.Error())
			return
		}
		dueDate = d
	}
