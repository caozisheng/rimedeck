...
import { ProjectsPage } from "@rimedeck/views/projects/components";
import { DashboardPage } from "@rimedeck/views/dashboard";
...
import { InboxPage } from "@rimedeck/views/inbox";
import { SettingsPage } from "@rimedeck/views/settings";
