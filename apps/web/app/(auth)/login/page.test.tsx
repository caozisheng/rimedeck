...
import enCommon from "@rimedeck/views/locales/en/common.json";
import enAuth from "@rimedeck/views/locales/en/auth.json";
import enSettings from "@rimedeck/views/locales/en/settings.json";
...
describe("LoginPage", () => {
  ...
  it("renders login form with email input and continue button", () => {
    ...
    expect(screen.getByText("Sign in to RimeDeck")).toBeInTheDocument();
  ...
  it("mints a token and deep-links to Desktop when already logged in with platform=desktop", async () => {
    ...
    try {
      ...
      expect(
        await screen.findByRole("button", { name: "Open RimeDeck Desktop" }),
      ).toBeInTheDocument();
    } finally {
      Object.defineProperty(window, "location", {
        configurable: true,
