 ...
 * yet schematised in @rimedeck/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@rimedeck/core/api/schemas";
...
// availability derivation in @rimedeck/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@rimedeck/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
